...
def test_schema_has_46_columns_and_no_ranges():
    assert "ranges" not in PLO_CSV_COLUMNS
    # 46-col shared template minus `ranges` (45) plus the PLO-only `hand_shape`.
    assert len(PLO_CSV_COLUMNS) == 46  # noqa: PLR2004
