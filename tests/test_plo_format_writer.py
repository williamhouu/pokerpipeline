...
def test_schema_has_48_columns_and_no_ranges():
    assert "ranges" not in PLO_CSV_COLUMNS
    # 48-col shared template minus `ranges` (47) plus the PLO-only `hand_shape`.
    assert len(PLO_CSV_COLUMNS) == 48  # noqa: PLR2004
