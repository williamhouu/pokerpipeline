...
CHECKER_SYSTEM_PROMPT = (
    ...
    "Do NOT flag correct general coaching, matters of style, emphasis, length, "
    "or defensible simplifications. When a claim is reasonable and correct, "
    "leave it alone. Be precise and conservative: only flag claims you are "
    "confident are wrong.\n\n"
