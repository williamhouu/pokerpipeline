...
CSV_COLUMNS = [
    ...
    # Followed by board_texture / validation_status (July 2026: the
    # solver_reference column was folded into Notes' `Node:` field; see
...
def build_row(spot_data: SpotData, difficulty_score: int, number: int, *,
    ...
    return {
        ...
        # Notes carries provenance + the node reference (the old
        # solver_reference value, now the Node: field). July 2026.
        "Notes": build_notes(
            "Auto-generated by poker-pipeline.",
            situation=(meta.position_dynamic or "").replace("_", " "),
            node_ref=_node_reference(meta),
        ),
